...
GroupAdd,cn,ahk_exe Evernote.exe
GroupAdd,cn,ahk_exe Dynalist.exe
GroupAdd,cn,ahk_exe anki.exe

;新开窗口时，切换到英文输入法的分组
GroupAdd,en,ahk_exe devenv.exe  ;Visual Studio
GroupAdd,en,ahk_exe dopus.exe 
GroupAdd,en,ahk_exe eudic.exe   ;欧路词典
GroupAdd,en,ahk_class studio.exe ;android studio
...
GroupAdd,editor,ahk_class code.exe   ;vscode
GroupAdd,editor,ahk_class gvim.exe   ;gvim
